...
$root .= DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR;
$root = realpath($root).DIRECTORY_SEPARATOR;
$rootPublic = $root;
$baseUrl = '/';
$systemconfig = array (
        'site' => array(
                'domain' => 'sphere.panchenko.dn.ua',
                'base_url' => 'http://sphere.panchenko.dn.ua',
                'title' => 'Сфера',
                'title_separator' => ' - ',
        ),
        'languages' => array(
...
//                        'dbname'        => 'sfera',
        ...
        'mail' => array(
                'default' => array(
                        'to_name' => 'Сфера',
                        'to_email' => 'kosmozilla@gmail.com',
                        'from_name' => 'Сфера',
                        'from_email' => 'kosmozilla@gmail.com',
                ),
		'useTransport' => true,
                'transport' => array(
                        'smtp' => array(
