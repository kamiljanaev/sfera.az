...
$(function(){
	...
	var dataGrid = $("#jqgridtable").jqGrid({
		...
		datatype: "json",
	   	colNames:['<?= $this->msgGridColumnDate ?>', '<?= $this->msgGridColumnTitle ?>', '<?= $this->msgGridColumnCategory ?>', '<?= $this->msgGridColumnImage ?>', '<?= $this->msgGridColumnUser ?>', '<?= $this->msgGridColumnIsHot ?>', '<?= $this->msgGridColumnModerate ?>', '<?= $this->msgGridColumnAction ?>'],
	   	colModel:[
            ...
            {name:'is_hot',index:'is_hot', width:100, align:"center", stype:'select', editoptions:{value:'<?= $this->hotList ?>'}},
