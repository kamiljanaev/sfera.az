...
--
-- Хост: localhost
-- Время создания: Мар 20 2012 г., 03:09
...
--
-- Дамп данных таблицы `site_awards`
--
...
--
-- Структура таблицы `site_awardslinks`
--
...
--
-- Дамп данных таблицы `site_awardslinks`
--
...
--
-- Структура таблицы `site_bookmarks`
--
...
--
-- Дамп данных таблицы `site_bookmarks`
--
...
--
-- Структура таблицы `site_bookmarks_category`
--
...
--
-- Дамп данных таблицы `site_bookmarks_category`
--
...
--
-- Структура таблицы `site_category_tree`
--
...
--
-- Дамп данных таблицы `site_category_tree`
--
...
--
-- Структура таблицы `site_documents`
--
...
--
-- Дамп данных таблицы `site_documents`
--
...
--
-- Структура таблицы `site_favorites`
--
...
--
-- Дамп данных таблицы `site_favorites`
--
...
--
-- Структура таблицы `site_friendslinks`
--
...
--
-- Дамп данных таблицы `site_friendslinks`
--
...
(30, 6, 1, 0, 0, '2012-03-13 19:08:11', '', 'sdfsdfsd', NULL, NULL, 'fsdfsdf', '<p>sdfsdf</p>', NULL),
(31, 6, 1, 0, 0, '2012-03-14 13:22:02', '', 'qwerqwer', NULL, NULL, 'qwerqwerqwr', '<p>qwerqwerqwer</p>', NULL),
(32, 6, 1, 0, 0, '2012-03-14 13:24:28', '', 'qwerqwer', NULL, NULL, 'qwerqwerqwr', '<p>qwerqwerqwer</p>', NULL),
(33, 6, 1, 0, 0, '2012-03-14 13:25:46', '', 'test', NULL, NULL, 'sfdssdf', '<p>sdfsdfsdf</p>', '2012-03-14 11:26:40'),
(34, 6, 1, 0, 0, '2012-03-14 00:00:00', '/upload/1331724386Untitled_HDR2.jpg', 'asdfasdf', '', '', 'asdfasdfasdf', '<p>asdfas<strong>dfasdfsdaf</strong></p>', NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `site_profiles`
--
...
--
-- Дамп данных таблицы `site_profiles`
--
...
--
-- Структура таблицы `site_scratch_cards`
--
...
--
-- Дамп данных таблицы `site_scratch_cards`
--
...
--
-- Структура таблицы `site_statuses`
--
...
--
-- Дамп данных таблицы `site_statuses`
--
...
--
-- Структура таблицы `site_subscribes`
--
...
--
-- Дамп данных таблицы `site_subscribes`
--
...
--
-- Дублирующая структура для представления `view_ads`
--
...
--
-- Дублирующая структура для представления `view_awards`
--
...
--
-- Дублирующая структура для представления `view_bookmarks`
--
...
--
-- Дублирующая структура для представления `view_bookmarks_category`
--
...
--
-- Дублирующая структура для представления `view_category_tree`
--
...
--
-- Дублирующая структура для представления `view_documents`
--
...
--
-- Дублирующая структура для представления `view_news`
--
...
--
-- Дублирующая структура для представления `view_profiles`
--
...
--
-- Дублирующая структура для представления `view_scratch_cards`
--
...
--
-- Дублирующая структура для представления `view_statuses`
--
...
--
-- Структура таблицы `view_subscribes`
--
-- используется(#1356 - View 'sphere.view_subscribes' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- используется (#1356 - View 'sphere.view_subscribes' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
--
-- Структура для представления `view_ads`
--
...
--
-- Структура для представления `view_awards`
--
...
--
-- Структура для представления `view_bookmarks`
--
...
--
-- Структура для представления `view_bookmarks_category`
--
...
--
-- Структура для представления `view_category_tree`
--
...
--
-- Структура для представления `view_documents`
--
...
--
-- Структура для представления `view_news`
--
...
--
-- Структура для представления `view_profiles`
--
...
--
-- Структура для представления `view_scratch_cards`
--
...
--
-- Структура для представления `view_statuses`
--
...
--
-- Ограничения внешнего ключа таблицы `site_ads`
--
...
--
-- Ограничения внешнего ключа таблицы `site_awardslinks`
--
...
--
-- Ограничения внешнего ключа таблицы `site_bookmarks`
--
...
--
-- Ограничения внешнего ключа таблицы `site_bookmarks_category`
--
...
--
-- Ограничения внешнего ключа таблицы `site_documents`
--
...
--
-- Ограничения внешнего ключа таблицы `site_favorites`
--
...
--
-- Ограничения внешнего ключа таблицы `site_friendslinks`
--
...
--
-- Ограничения внешнего ключа таблицы `site_news`
--
...
--
-- Ограничения внешнего ключа таблицы `site_story`
--
...
--
-- Ограничения внешнего ключа таблицы `site_subscribes`
--
